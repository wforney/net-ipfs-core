...
/// <see cref="ToBase32"/> to encode a byte array and <see cref="FromBase32"/> to decode a Base-32 string.
/// </para>
/// <para>
/// <see cref="Encode"/> and <see cref="ToBase32"/> produce the lower case form of <see
/// href="https://tools.ietf.org/html/rfc4648"/> with no padding. <see cref="Decode"/> and <see
/// cref="FromBase32"/> are case-insensitive and allow optional padding.
/// </para>
/// <para>A thin wrapper around <see href="https://github.com/ssg/SimpleBase"/>.</para>
/// </remarks>
