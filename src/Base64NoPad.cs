...
public static class Base64NoPad
{
    ...
    ///   The string representation, in base 64, of the contents of <paramref name="bytes"/>.
    /// </returns>
    public static string ToBase64NoPad(this byte[] bytes) => Encode(bytes);
    ...
    public static byte[] Decode(string s)
    {
        ...
        switch (s.Length % 4) // Pad with trailing '='s
        {
            ...
            default: throw new FormatException("Illegal base64 string!");
        }
    ...
    ///   An array of 8-bit unsigned integers that is equivalent to <paramref name="s"/>.
    /// </returns>
    public static byte[] FromBase64NoPad(this string s) => Decode(s);
}
