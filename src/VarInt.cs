...
public static class Varint
{
    ...
    ///   The number of bytes required to encode the value.
    /// </returns>
    public static int RequiredBytes(long value) => Encode(value).Length;
    ...
    /// </exception>
    public static void WriteVarint(this Stream stream, long value) => stream.WriteVarintAsync(value).ConfigureAwait(false).GetAwaiter().GetResult();
    ...
    /// </exception>
    /// <returns>The integer value.</returns>
    public static int ReadVarint32(this Stream stream) => stream.ReadVarint32Async().ConfigureAwait(false).GetAwaiter().GetResult();
    ...
    /// </exception>
    /// <returns>The integer value.</returns>
    public static long ReadVarint64(this Stream stream) => stream.ReadVarint64Async().ConfigureAwait(false).GetAwaiter().GetResult();
    ...
    {
        long value = await stream.ReadVarint64Async(cancel).ConfigureAwait(false);
