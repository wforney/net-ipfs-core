...
public class HashingAlgorithm
{
    ...
    internal static Dictionary<int, HashingAlgorithm> Codes = [];
    ...
    {
        _ = Register("sha1", 0x11, 20, SHA1.Create);
        _ = Register("sha2-256", 0x12, 32, SHA256.Create);
        _ = Register("sha2-512", 0x13, 64, SHA512.Create);
        _ = Register("dbl-sha2-256", 0x56, 32, () => new DoubleSha256());
        _ = Register("keccak-224", 0x1A, 224 / 8, () => new KeccakManaged(224));
        _ = Register("keccak-256", 0x1B, 256 / 8, () => new KeccakManaged(256));
        _ = Register("keccak-384", 0x1C, 384 / 8, () => new KeccakManaged(384));
        _ = Register("keccak-512", 0x1D, 512 / 8, () => new KeccakManaged(512));
        _ = Register("sha3-224", 0x17, 224 / 8, () => new BouncyDigest(new BC.Sha3Digest(224)));
        _ = Register("sha3-256", 0x16, 256 / 8, () => new BouncyDigest(new BC.Sha3Digest(256)));
        _ = Register("sha3-384", 0x15, 384 / 8, () => new BouncyDigest(new BC.Sha3Digest(384)));
        _ = Register("sha3-512", 0x14, 512 / 8, () => new BouncyDigest(new BC.Sha3Digest(512)));
        _ = Register("shake-128", 0x18, 128 / 8, () => new BouncyDigest(new BC.ShakeDigest(128)));
        _ = Register("shake-256", 0x19, 256 / 8, () => new BouncyDigest(new BC.ShakeDigest(256)));
        _ = Register("blake2b-160", 0xb214, 160 / 8, () => new BouncyDigest(new BC.Blake2bDigest(160)));
        _ = Register("blake2b-256", 0xb220, 256 / 8, () => new BouncyDigest(new BC.Blake2bDigest(256)));
        _ = Register("blake2b-384", 0xb230, 384 / 8, () => new BouncyDigest(new BC.Blake2bDigest(384)));
        _ = Register("blake2b-512", 0xb240, 512 / 8, () => new BouncyDigest(new BC.Blake2bDigest(512)));
        _ = Register("blake2s-128", 0xb250, 128 / 8, () => new BouncyDigest(new BC.Blake2sDigest(128)));
        _ = Register("blake2s-160", 0xb254, 160 / 8, () => new BouncyDigest(new BC.Blake2sDigest(160)));
        _ = Register("blake2s-224", 0xb25c, 224 / 8, () => new BouncyDigest(new BC.Blake2sDigest(224)));
        _ = Register("blake2s-256", 0xb260, 256 / 8, () => new BouncyDigest(new BC.Blake2sDigest(256)));
        _ = Register("md4", 0xd4, 128 / 8, static () => new BouncyDigest(new BC.MD4Digest()));
        _ = Register("md5", 0xd5, 128 / 8, MD5.Create);
        _ = Register("identity", 0, 0, () => new IdentityHash());
        _ = RegisterAlias("id", "identity");
    }
    ...
    /// </exception>
    public static HashAlgorithm GetAlgorithm(string name) => GetAlgorithmMetadata(name).Hasher();
