...
/// <summary>
/// Unit tests for <see cref="Duration"/>.
/// </summary>
[TestClass]
public class DurationTest
{
    ...
    /// </summary>
    [TestMethod]
    public void Parsing_InvalidUnit() => _ = ExceptionAssert.Throws<FormatException>(() => _ = Duration.Parse("1jiffy"), "Unknown IPFS duration unit 'jiffy'.");

    /// <summary>
    /// Missing number.
    /// </summary>
    [TestMethod]
    public void Parsing_MissingNumber() => _ = ExceptionAssert.Throws<FormatException>(() => _ = Duration.Parse("s"));

    /// <summary>
    /// Missing unit.
    /// </summary>
    [TestMethod]
    public void Parsing_MissingUnit() => _ = ExceptionAssert.Throws<FormatException>(() => _ = Duration.Parse("1"), "Missing IPFS duration unit.");
